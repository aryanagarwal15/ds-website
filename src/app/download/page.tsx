            ...
            <div className="flex gap-6">
                ...
                {/* <a href={PLAY_STORE_URL} target="_blank" rel="noopener noreferrer">
                    <img
                        ...
                        className="h-14 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200 opacity-50 pointer-events-none"
                    />
                </a> */}
            </div>
            <p className="font-cormorant text-[0.9rem] text-[#DA8852] mt-6">
